  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Production Batches</h2>
          ...
          <form onSubmit={(e) => {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select 
                  name="product_id" 
                  value={selectedBatch?.product_id || ""}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select name="status" value={selectedBatch?.status || "in_progress"}>
                  <SelectTrigger>
